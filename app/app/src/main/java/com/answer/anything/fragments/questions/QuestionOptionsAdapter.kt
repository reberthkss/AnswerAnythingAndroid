...
class QuestionOptionsAdapter (private val options: HashMap<Int, String>, private val setSelectedOption: (option: Int) -> Unit) : RecyclerView.Adapter<QuestionOptionsAdapter.ViewHolder>() {
